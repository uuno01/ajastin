...
if __name__ == "__main__":
   ...
   # root.geometry(str(ay)+"x"+str(ax)) 
    ...
    variable4.set(joukn[0]) # default value    
    ...
    if yhteys ==True:
        variable5.set(lajitn[12]) # default value    
        w5 = OptionMenu(root, variable5, *lajitn, command=lambda x: tyo(variable5))
    elif yhteys==False:
        variable5.set(lajiti[0]) # default value    
